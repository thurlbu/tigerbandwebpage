    ...
    <div id="Col2FlexContent" class="about">
        <div id="col1Flex">
            <article class="text fullWidth">
                <h1 class="purpleText">2017 Tiger Dancers Auditions</h1>
                <p>Auditions for the 2017 Tiger Dancers and Twirlers will be held on Sunday, April 30 in room 112 of the Brooks Center.</p>
                <p>We look forward to meeting and working with each of you! Being a member of the Tiger Dancers is a life-changing experience that you will never forget. It is an incredible opportunity and we want you to be a part of it!</p>
                <a href="../../doc/2017Dancer.pdf" class="richLink" target="_blank">Tiger Dancer Audition Information</a>
                <p>If you have any questions concerning auditions for the Dancers, please contact Hazel Cartee: <a href="mailto:Hazel@UpstateDance.com?subject=Tiger Dancers Audition Question">Hazel@UpstateDance.com</a></p>
            </article>
            ...
            <div class="deadlines">
                <div class="month">
                    ...
                    <div class="deadlinesInfo" id="info1">
                        <p>Tiger Dancers Auditions<br>
                            Starting at 3:30pm<br>
