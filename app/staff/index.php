...
<body>
    ...
    <div class="articles_container about">
        <div class="articles">
            <article class="text">
    ...
    <div class="articles_container">
        <div class="articles force-full-width">
            <article class="text expand" onclick="expand(this)">
                <div class="expandButton">
                    <img src="/img/logos/dropdownArrow.svg" width="75">
                </div>
                <div class="article__content">
                    <h1 class="staff-name">Dr. Mark Spede</h1>
                    <h2 class="staff-title">Director of Bands</h2>
                    <div class="staffBio">
                        <img class="staffPortrait" src="/img/staff/Spede.png">
            ...
            <article class="text expand" onclick="expand(this)">
                ...
                <div class="article__content">
                    <h1 class="staff-name">Ms. Lee Maiden</h1>
                    <h2 class="staff-title">Administrative coordinator</h2>
                    <div class="staffBio">
            ...
            <article class="text expand" onclick="expand(this)">
                ...
                <div class="article__content">
                    <h1 class="staff-name">Mr. Terry Kent</h1>
                    <h2 class="staff-title">Color Guard Instructor</h2>
                    <div class="staffBio">
            ...
            <article class="text expand" onclick="expand(this)">
                ...
                <div class="article__content">
                    <h1 class="staff-name">Ms. Hazel Cartee</h1>
                    <h2 class="staff-title">Twirler Instructor</h2>
                    <div class="staffBio">
            ...
            <article class="text expand" onclick="expand(this)">
                ...
                <div class="article__content">
                    <h1 class="staff-name">Mr. Larry Sloan</h1>
                    <h2 class="staff-title">Tiger Band Videographer</h2>
                    <div class="staffBio">
            ...
            <article class="text expand" onclick="expand(this)">
                ...
                <div class="article__content">
                    <h1 class="staff-name">Mr. Christopher Sloan</h1>
                    <h2 class="staff-title">Tiger Band Photographer</h2>
                    <div class="staffBio">
            ...
            <article class="text expand" onclick="expand(this)">
                ...
                <div class="article__content">
                    <h1 class="staff-name">Mr. Jeff Norman</h1>
                    <h2 class="staff-title">Visual Assistant</h2>
                    <div class="staffBio">
        ...
        <div class="articles force-full-width">
            <article class="text expand" onclick="expand(this)">
                ...
                <div class="article__content">
                    <h1 class="staff-name">Mr. Timothy Hurlburt</h1>
                    <h2 class="staff-title">Assistant Director of Bands</h2>
                    <div class="staffBio">
            ...
            <article class="text expand" onclick="expand(this)">
                ...
                <div class="article__content">
                    <h1 class="staff-name">Dr. Paul Buyer</h1>
                    <h2 class="staff-title">Director of Percussion</h2>
                    <div class="staffBio">
            ...
            <article class="text expand" onclick="expand(this)">
                ...
                <div class="article__content">
                    <h1 class="staff-name">Mr. Lance Curry</h1>
                    <h2 class="staff-title">Drumline Instructor</h2>
                    <div class="staffBio">
            ...
            <article class="text expand" onclick="expand(this)">
                ...
                <div class="article__content">
                    <h1 class="staff-name">Ms. Marilla Riggs</h1>
                    <h2 class="staff-title">Dancer Instructor</h2>
                    <div class="staffBio">
            ...
            <article class="text expand" onclick="expand(this)">
                ...
                <div class="article__content">
                    <h1 class="staff-name">Dr. Tim Willis</h1>
                    <h2 class="staff-title">Tiger Band Announcer</h2>
                    <div class="staffBio">
            ...
            <article class="text expand" onclick="expand(this)">
                ...
                <div class="article__content">
                    <h1 class="staff-name">Mr. Randy Christ</h1>
                    <h2 class="staff-title">Tiger Band Videographer</h2>
                    <div class="staffBio">
            ...
            <article class="text expand" onclick="expand(this)">
                ...
                <div class="article__content">
                    <h1 class="staff-name">Mrs. Tamara Sloan</h1>
                    <h2 class="staff-title">Tiger Band Photographer</h2>
                    <div class="staffBio">
