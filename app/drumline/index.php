...
<head>
  ...
  <script>
    ...
    <meta charset="utf-8">
    <title>Clemson University Drumline</title>
...
<body>
    <!--- MAIN PHOTO --->
    <div id="homeFullscrContainer" class="drumline">
        ...
        <div class="homepageNav">
            ...
            <a href="contact/">
                <div class="boxWrapper">
                    <div id="homepageNav3" class="boxUIelement rect white">
                        <div class="textContainer">
                            <p>Contact</p>
                        </div>
                    </div>
    ...
    <img class="clemsonLogo" src="img/logos/clemsonPaw.svg">
    ...
    <div id="Col2FlexContent" class="homepage">
        <div id="col1Flex">
            <article class="media">
                <h1 class="orangeText">2024 Video Audition Requirements</h1>
        ...
        <div id="col2Flex">
          ...
          <article class="text">
              <h1 class="orangeText">2024 Clemson University Drumline PAW</h1>
              <img class="articleImg" src='img/2019Drumline.jpg'>
              <p>Looking for a little extra help with your 2024 Drumline Audition?</p>
              <p>Join our 2024 Section Leaders and instructional staff on Saturday, May 4 for a free workshop to help sharpen your skills and answer any questions you may have about the Clemson University Drumline or our audition process.</p>
              ...
              <p><a href="https://docs.google.com/forms/d/e/1FAIpQLSde61C389qTfQCChtwPz4pcHvOSLQyfJKcaFsnshiJtRLXIWA/viewform?usp=sf_link">REGISTER TODAY</a> for the 2024 <b>P</b>re-<b>A</b>udition <b>W</b>orkshop!</p>
          </article>
...
<script type="text/javascript">
    ...
    function expand(x) {
        if (document.getElementById("expand" + x).className == "hide") {
            document.getElementById("expand" + x).className = "show";
            ...
            document.getElementById("expand" + x).className = "hide";
            document.getElementById("button" + x).style.transform = "rotateX(360deg)";
            document.getElementById("button" + x).style.webkitTransform = "rotateX(360deg)";
        }
    }
    //Copyright Date
    var startYear = 2017;
