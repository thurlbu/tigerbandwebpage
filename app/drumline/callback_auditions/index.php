...
<body>
    <div class="heading">
        ...
        <h4>2026 Clemson University Drumline</h4>
    </div>
    ...
    <div id="Col2FlexContent" class="auditions">
        ...
        <div id="col2Flex">
            <article class="text fullWidth">
                ...
                <p>2026 Full Preseason Schedule</p>
            </article>
        </div>
    </div>
