...
<body>
    <div class="heading">
        ...
        <h4>2025 Clemson University Drumline</h4>
    </div>
        ...
        <div class="month num2">
            ...
            <div class="deadlinesInfo" id="info4">
                <p>Audition results announced</p>
                  <br>
                <p>Those selected must report to CALL BACK auditions on Monday, August 11</p>
            </div>
        </div>
    ...
    <div id="Col2FlexContent" class="auditions">
        <div id="col1Flex">
            <article class="text fullWidth">
                <h1 class="purpleText">2025 Drumline Auditions</h1>
                ...
                <p>Auditionees will be notified about video audition results by June 28. Students who earn a call-back audition invitation will move to Clemson on August 11 to participate in the live audition round before Tiger Band's preseason camp begins.</p>
        ...
        <div id="col2Flex">
            <article class="text fullWidth">
                ...
                <p>2025 Full Preseason Schedule</p>
            </article>
        </div>
    </div>
...
<p>Following the video audition, the live audition process will consist of two parts; an ensemble evaluation and an individual evaluation. In the ensemble evaluation, each section will audition together as a line on a rotating basis trying various player combinations. During the individual evaluation, students will be asked to sight read and may be asked to play <strong>any</strong> of the <a href="/music/">music</a> found on the website.</p>
        ...
        <article class="text fullWidth">
            ...
            <ul>
                <li>3-ring binder with all <a href="https://docs.google.com/document/d/1K8HMaopNcJwJFDNlff3y6RL3ttI2FfvE8Ta_pgUd77A/edit">music</a> for your section in plastic page protectors (for use during auditions, through camp, and into the early season)</li>
                <li>Practice page</li>
                <li>Sticks</li>
                    <ul>
