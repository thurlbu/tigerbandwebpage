...
<body>
    <div class="heading">
        ...
        <h4>2026 Video Audition Information</h4>
    </div>
    ...
    <div id="Col2FlexContent" class="auditions">
        ...
        <div id="col2Flex">
            ...
            <article class="text fullWidth">
                <h1 class="purpleText">2026 Clemson University Drumline Auditions</h1>
    ...
    <div class="process">
        ...
        <div class="processItem">
            ...
            <div class="processText">
                ...
                <p>You will receive an email from us containing your status for call-back auditions by June 27.</p>
            </div>
        </div>
    </div>
