...
<body>
    ...
    <div class="articles_container">
        <div class="articles">
            <article class="text">
                <img class="article__image" src='/img/KKP.jpg'>
            ...
            <article class="text">
                <img class="article__image" src='/img/BruceAlumni.jpg'>
                <div class="article__content">
            ...
            <article class="text">
                <img class="article__image" src='/img/TigerBandMediaBanner.png'>
                <div class="article__content">
            ...
            <article class="text">
                <img class="article__image" src='/img/MovingImages.jpg'>
                <div class="article__content">
        ...
        <div class="articles">
            <article class="text">
                <img class="article__image" src='/img/PMA.jpg'>
                <div class="article__content">
            ...
            <article class="text">
                <img class="article__image" src='/img/Brooks.jpg'>
                <div class="article__content">
                    ...
                    <div id="socMedContainer" class="organizations">
                        <div id="icons">
                            ...
                            <a href="https://www.instagram.com/brookscentercu" target="_blank">
                                <div id="instagram" class="socialBorder">
                                    <img class="socialIcon" src="/img/logos/instagram.png">
                                </div>
                            </a>
                            <a href="https://twitter.com/BrooksCenterCU" target="_blank">
                                <div id="twitter" class="socialBorder">
                                    <img class="socialIcon" src="/img/logos/twitter.png">
                                </div>
                            </a>
                            <!-- TODO: Re-design buttons to add this in
            ...
            <article class="text">
                <img class="article__image" src='/img/ImagineStudiosPic.png'>
                <div class="article__content">
