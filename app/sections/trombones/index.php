...
<head>
  ...
  <script>
    ...
    <meta charset="utf-8">
    <title>Trombone Section | Tiger Band</title>
...
<body>
  ...
  <div class="media-container">
    <video playsinline autoplay loop muted>
        <source src="https://d3fdmt0abme096.cloudfront.net/section-pages/Trombone+Section+Page+Video.mp4" type="video/mp4">
    </video>
  </div>
  ...
  <div class="auditionButton">
      <a href="/join/winds/" class="boxWrapper">
          <div id="auditionToday" class="boxUIelement rect trombone">
              <div class="textContainer">
                  <p>Be a part of the saga!</p>
              </div>
          </div>
      </a>
  </div>
